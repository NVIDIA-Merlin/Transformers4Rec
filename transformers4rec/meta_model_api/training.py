...
def fit(trainer, start_time_window_index, final_time_window_index):
...
def incremental_fit(trainer, start_time_window_index, final_time_window_index):
    for time_index in range(start_time_window_index, final_time_window_index+1):
        fit(trainer, time_index, time_index)
