...
* End-to-end session-based recommendation: [TensorFlow](03-End-to-end-session-based-with-Yoochoose-TF.ipynb) | [PyTorch](02-End-to-end-session-based-with-Yoochoose-PyT.ipynb)