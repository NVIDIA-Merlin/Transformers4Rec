...
# 
# Finally, if you have worked with the <b>synthetic</b> data set in notebook 01, remember to change the values 178 and 181 in the next cell accordingly:
