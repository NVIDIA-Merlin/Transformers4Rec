...
class XLNetConfig(PretrainedConfig):
    """
        ...
        Args:
            product_vocab_size (:obj:`int`, optional, defaults to 32000):
    ...
    def __init__(
        self,
        product_vocab_size=32000,
        category_vocab_size=10000,
        brand_vocab_size=1000,
        d_model=1024,
        n_layer=24,
        n_head=16,
        d_inner=4096,
        ...
        **kwargs
        ...
        self.brand_vocab_size = brand_vocab_size
    ...
    def n_token(self):  # Backward compatibility
        return self.product_vocab_size

    @n_token.setter
    def n_token(self, value):  # Backward compatibility
        self.product_vocab_size = value
